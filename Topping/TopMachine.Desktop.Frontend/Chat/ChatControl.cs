...
namespace TopMachine.Topping.Frontend.Chat
{
    ...
    public partial class ChatControl : UserControl, IMessageHandler
    {
        ...
        public ChatControl()
        {
			...
			pnlChat.Document.DocumentElement.InnerHTML = TopMachine.Topping.Frontend.Properties.Resources.DefaultHTML; 
        }
        ...
        {
			Mono.WebBrowser.DOM.IElement el = pnlChat.Document.CreateElement("div");

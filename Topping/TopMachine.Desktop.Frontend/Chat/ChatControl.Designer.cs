    ...
    partial class ChatControl
    {
        ...
        private void InitializeComponent()
        {
			...
			try {
				...
				this.pnlChat = Mono.WebBrowser.Manager.GetNewInstance();
				this.pnlChat.Load(this.Handle,this.Width,this.Height);
			...
			//this.pnlChat.LoadFinished += new System.Windows.Forms.WebBrowserDocumentCompletedEventHandler(this.pnlChat_DocumentCompleted);
            // 
            // ChatControl
            // 
		...
		private Mono.WebBrowser.IWebBrowser pnlChat;
    }
}
